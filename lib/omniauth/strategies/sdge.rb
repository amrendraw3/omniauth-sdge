    ...
    class Sdge < OmniAuth::Strategies::OAuth2
      ...
      unless OmniAuth.config.test_mode
        option :client_options, {
          :authorize_url => "#{BASE_URL}/DataCustodian/oauth/authorize?DataCustodianID=SDGE&IntervalDuration%3D900_3600%3BBlockDuration%3DDaily%3BBR%3D1%3BHistoryLength%3D34128000%3BSubscriptionFrequency%3DDaily%3B",
